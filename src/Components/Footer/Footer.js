    ...
    <div className='footersectioncontainer'>
        <div className='footercontainer'>
            <div className='footergridcontainer'>
                <div className='footercardcontainer1'>
                    <h3><span>Le</span>t's Work <br></br> together</h3>
                    <div>
                        <span>Based in Germany |</span>
                        <ul>
                                <li><span><AiFillAppstore /></span></li>
                                <li><span><FaLinkedin/></span></li>
                                <li><span><FaGlobe/></span></li>
                                <li><span><FaGithub/></span></li>
                        </ul>
                    </div>
                </div>
                <div className='footercardcontainer2'>
                    <h3>Looking for a hectic  designer?</h3>
                    
                        <p>hello@henry.com</p>
                        <a href="contact.html" class="text-white group-hover:animate-arrow-move-up group-hover:text-orange">
                ...
                <div className='footercardcontainer2'>
                    <h3>Want a more in-depth look at my history?</h3>
                    <div>
                        <p>+598 6879 9874</p>
                        <a href="contact.html" class="text-white group-hover:animate-arrow-move-up group-hover:text-orange">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='footernamegridcontainer'>
                <div>
            ...
            <div className='footerbottomcontainer'>
                <p>©2023 Mark Henry, All Rights Reserved</p>
                 <div>
